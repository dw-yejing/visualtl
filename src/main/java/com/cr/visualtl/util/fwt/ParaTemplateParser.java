...
@Slf4j
public class ParaTemplateParser implements TemplateParser {
    /**
     * 待解析的文本
     */
    private String text;
    ...
    ParaTemplateParser(String docText, List<String> removeTagList, Map<String, String> bookmarkMap){
        this.text = docText;
    ...
    public String invoke() {
        ...
        while(paraMatcher.find()){
            ...
            try {
                docText = generateCustomDomPara(docText, itemValue);
            } catch (Exception e) {
                e.printStackTrace();
                log.error("成文模板解析异常");
            }
    ...
    private String generateCustomDomPara(String docText, String itemValue) throws Exception{
        ...
        Element target = TemplateParser.getTargetNode(tableBookmarkStartNode, FwtElement.WORD_P_TAG);
