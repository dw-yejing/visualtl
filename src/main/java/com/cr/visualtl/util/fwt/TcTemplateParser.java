...
@Slf4j
public class TcTemplateParser implements TemplateParser {
    /**
     * 待解析的文本
     */
    private String text;
    ...
    TcTemplateParser(String docText, List<String> removeTagList, Map<String, String> bookmarkMap){
        this.text = docText;
    ...
    public String invoke() {
        ...
        while(cellMatcher.find()){
            ...
            try {
                docText = generateCustomDomCell(docText, itemValue);
            } catch (Exception e) {
                e.printStackTrace();
                log.error("成文模板解析异常");
            }
    ...
    private String generateCustomDomCell(String docText, String itemValue) throws Exception{
        ...
        Element target = TemplateParser.getTargetNode(tableBookmarkStartNode, FwtElement.WORD_TC_TAG);
